...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_ALT,    KC_Q,           KC_W,           KC_F,           TD(DANCE_1),    TD(DANCE_2),                                    TD(DANCE_4),    TD(DANCE_5),    KC_U,           KC_Y,           KC_SCLN,        KC_BSLS,        
    ...
    KC_PSCR,        KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT, 
                                                    TD(DANCE_3),    KC_BSPC,                                        KC_SPACE,       TG(1)
  ),
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         
    KC_TRANSPARENT, KC_EXLM,        KC_HOME,        KC_UP,          KC_END,         TD(DANCE_6),                                    MT(MOD_RSFT, KC_SLASH),KC_7,           KC_8,           KC_9,           KC_SLASH,       KC_F12,         
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_Q,           TD(DANCE_7),    MT(MOD_LALT, KC_E),MT(MOD_LSFT, KC_R),MT(MOD_LCTL, KC_T),                                MT(MOD_RCTL, KC_Y),MT(MOD_RSFT, KC_U),MT(MOD_LALT, KC_I),TD(DANCE_8),    KC_P,           KC_BSLS,        
    ...
    KC_TRANSPARENT, KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       ST_MACRO_0,     
                                                    KC_TRANSPARENT, KC_BSPC,                                        TD(DANCE_9),    TO(0)
  ),
  [3] = LAYOUT_voyager(
